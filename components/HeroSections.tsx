...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 overflow-hidden">
      ...
      <span className="absolute top-20 right-20 w-4 h-4 bg-orange-400 rounded-full animate-ping" />
      <span className="absolute top-40 right-40 w-2 h-2 bg-amber-500 rounded-full animate-ping" style={{ animationDelay: '0.5s' }} />
      <span className="absolute bottom-40 left-20 w-3 h-3 bg-orange-500 rounded-full animate-ping" style={{ animationDelay: '1s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[calc(100vh-6rem)]">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-6 w-full max-w-md p-4 bg-white/60 backdrop-blur-sm rounded-xl border-l-4 border-orange-500"
            >
              <p className="text-2xl sm:text-3xl text-orange-700 mb-1">
                हरे कृष्ण हरे कृष्ण
              </p>
